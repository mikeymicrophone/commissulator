module CommissionsHelper
  ...
  def commission_row_for commission
    columns = [
      ...
      content_tag(:td, number_to_round_currency(commission.leased_monthly_rent)),
      content_tag(:td, link_to(number_to_round_currency(commission.total_commission), commission)),
