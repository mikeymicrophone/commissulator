...
class DealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deal" do
    assert_difference('Deal.count') do
      post deals_url, params: { deal: { address: @deal.address, name: @deal.name, status: @deal.status, unit_number: @deal.unit_number } }
    end
  ...
  test "should update deal" do
    patch deal_url(@deal), params: { deal: { address: @deal.address, name: @deal.name, status: @deal.status, unit_number: @deal.unit_number } }
