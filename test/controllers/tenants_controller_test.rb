...
class TenantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tenant" do
    assert_difference('Tenant.count') do
      post tenants_url, params: { tenant: { client_id: @tenant.client_id, lease_id: @tenant.lease_id } }
    end
  ...
  test "should update tenant" do
    patch tenant_url(@tenant), params: { tenant: { client_id: @tenant.client_id, lease_id: @tenant.lease_id } }
